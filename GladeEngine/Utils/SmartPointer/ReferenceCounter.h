#ifndef GLADE_REFERENCE_COUNTER_H
#define GLADE_REFERENCE_COUNTER_H
...
public:
	...
	void AddStrongReference() { ++strongCount; }
	...
	void Release()
	{
		if(--strongCount == 0)
		{
			...
			// If 1 WeakReference exists, this makes weakCount 1, so *this isn't deleted
				// until that WeakReference is deleted
		}
	}
	...
	void WeakRelease() { if(--weakCount == 0) delete this; }
...
#endif	// GLADE_REFERENCE_COUNTER_H
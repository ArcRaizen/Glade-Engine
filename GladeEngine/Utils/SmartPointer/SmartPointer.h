#ifndef GLADE_SMART_POINTER_H
#define GLADE_SMART_POINTER_H
...
// Any class "T" that makes this class a friend of it can use SmartPointer<T>'s in place of T*.
...
// Classes utilizing this class should use private/protected constructors and static "create" functions for each constructor that returns a SmartPointer<T> object.

// Proper syntax to make this class a friend is: "template <typename T> friend class SmartPointer;"
